-- OUTSRC: SQL con thieu (idempotent).
-- 012 HOP_DONG_NHAN_SU + thoi han | 014 chiet_giam_tncttt | 016 RLS


-- ========== 012_add_hop_dong_thoi_han_nhan_su.sql ==========
